...
* 🎓 **Carrera:** Ingeniería en Sistemas (FICCT - UAGRM).
* 💻 **Entorno de trabajo:** Desarrollo en sistemas Linux (Linux Mint) y Windows.
* 🎯 **Áreas de interés:** Estructuras de Datos, Algoritmos, Desarrollo de Software e Inteligencia Artificial.
